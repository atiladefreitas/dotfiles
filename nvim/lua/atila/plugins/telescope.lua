...
theme.on_change("telescope", function(p)
	local groups = {
		...
		TelescopeSelectionCaret = { fg = p.cyan, bg = p.selection },

		TelescopePromptPrefix = { fg = p.cyan, bg = p.bg },
		TelescopePromptNormal = { bg = p.bg },
		TelescopePromptBorder = { bg = p.bg, fg = p.stroke },
		TelescopePromptTitle = { fg = p.cyan, bg = p.bg, bold = true },
		TelescopePromptCounter = { fg = p.fg_dark, bg = p.bg },

		TelescopeResultsNormal = { bg = p.bg },
		TelescopeResultsBorder = { bg = p.bg, fg = p.stroke },
		TelescopeResultsTitle = { fg = p.stroke, bg = p.bg },

		TelescopePreviewNormal = { bg = p.bg },
		TelescopePreviewBorder = { bg = p.bg, fg = p.stroke },
		TelescopePreviewTitle = { fg = p.green, bg = p.bg, bold = true },
	}
