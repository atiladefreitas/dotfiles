...
conform.setup({
	formatters_by_ft = {
		javascript = { "rustywind", "prose_sort", "prettier" },
		typescript = { "rustywind", "prose_sort", "prettier" },
		javascriptreact = { "rustywind", "prose_sort", "prettier" },
		typescriptreact = { "rustywind", "prose_sort", "prettier" },
	...
	formatters = {
		...
		-- prettier is unconditional. It used to be gated on the project *not*
		-- having a biome.json, with biome taking those projects instead; biome
		-- is gone, so that gate would only ever have been a way to end up with
		-- no formatter at all in a repo that happens to ship a biome config.
		prettier = {
