			...
			["biome"] = function()
				lspconfig["biome"].setup({
					...
					on_attach = function(client, bufnr)
						...
						-- You can add buffer-local keymaps here if necessary

						-- Example custom command
						vim.api.nvim_buf_create_user_command(bufnr, "BiomeFormat", function()
							vim.lsp.buf.format({ async = true })
						end, { desc = "Format current buffer with Biome" })
					end,
					settings = {
						biome = {
							...
							experimental = {
								ai = {
									features = {
										auto_completion = false, -- Replace with your desired config
										spell_check = true,
									},
								},
							},
